  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved extension as @extension" do
        ...
        post :create, {:extension => { "name" => "invalid value" }}, valid_session
        assigns(:extension).should be_a_new(Extension)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested extension" do
        ...
        Extension.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => extension.to_param, :extension => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the extension as @extension" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Extension.any_instance.stub(:save).and_return(false)
        put :update, {:id => extension.to_param, :extension => { "name" => "invalid value" }}, valid_session
        assigns(:extension).should eq(extension)
      end
